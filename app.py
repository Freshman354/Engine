...
def connect_shopify_callback():
    ...
    # {api_key} is SHOPIFY_APP_CLIENT_ID. Passed through as a query param
    # rather than redirecting straight to it — that's a dashboard/
    # onboarding.html UI decision (a button/banner, not a forced redirect
    # away from Lumvi), which I don't have those templates in hand to wire
    # up yet.
    activate_embed_url = (
