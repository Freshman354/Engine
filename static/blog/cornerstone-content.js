...
const CORNERSTONE_ARTICLE = {
  ...
  bodyHTML: `
    ...
    <p>You pay the platform a flat fee per client account, and you charge the client a markup on that seat. It's easy to explain in a proposal — "$X per month per chatbot" — and it's easy to forecast. The risk is a high-volume client burning far more in usage than their seat covers, quietly eating your margin.</p>
